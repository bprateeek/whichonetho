        ...
        {value?.previewUrl ? (
          <>
            ...
            <button
              ...
              className="font-geist absolute top-2 right-2 w-8 h-8 bg-black/50 hover:bg-black/70 text-white rounded-full flex items-center justify-center transition-colors"
            >
              ×
            </button>
          </>
