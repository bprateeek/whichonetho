    ...
    >
      <div className="flex">
        ...
        <div className="flex-1 p-3 flex flex-col justify-between min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              {poll.context && (
                <span className="font-geist inline-block px-2 py-0.5 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 text-xs rounded-full capitalize truncate">
                  {poll.context}
                </span>
              )}
        ...
        <div className="flex items-center pr-3">
          <svg
            className="font-geist w-5 h-5 text-gray-400 dark:text-gray-500"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
